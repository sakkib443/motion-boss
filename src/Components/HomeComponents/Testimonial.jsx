        ...
        <section className="py-12 bg-gray-50 sm:py-16 lg:py-20">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="flex flex-col items-center">
                   <SectionTitle title={'আমাদের কিছু খুশি ক্লায়েন্টের কথা'} subtitle={'আমাদের সাথে সুন্দর হবে আপনার পথ চলা'}></SectionTitle>
                    <div className="mt-4 text-center md:mt-6 md:order-3">
                        <a href="#" title="" className="pb-2 text-base font-bold leading-7 text-gray-900 transition-all duration-200 border-b-2 border-gray-900 hover:border-gray-600 font-pj focus:outline-none focus:ring-1 focus:ring-gray-900 focus:ring-offset-2 hover:text-gray-600"> সব রিভিউগুলো দেখুন > </a>
                    </div>
